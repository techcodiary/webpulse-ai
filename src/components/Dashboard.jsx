  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const lighthouseResponse = await fetch(
        'http://localhost:5000/lighthouse',
        {
          method: 'POST',
      ...
      const meta_response = await fetch(
        'http://localhost:5000/analyze-meta-tags',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
              ...
              <div style={{ padding: '20px' }}>
                ...
                {results && (
                  <div style={{ marginTop: '20px' }}>
                    ...
                    <p>
                      <strong>Keywords:</strong> {results.keywords}
                    </p>
                    <p>
            ...
            <div className="mt-8">
              ...
              <ul className="space-y-3">
                {recommendations.map((rec, index) => (
                  <li
                    key={index}
                    className="p-4 rounded-md bg-yellow-50 border-l-4 border-yellow-400 shadow"
                  >
